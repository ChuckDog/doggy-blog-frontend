      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <nav className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <span>/</span>
            <Link href="/tags" className="hover:text-orange-600 transition-colors">标签</Link>
            <span>/</span>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 mb-12 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            ...
            {!['金毛犬', '宠物故事', '日常', '训练技巧', '行为矫正', '新手必读', '营养搭配', '自制狗粮', '健康管理', '旅行攻略', '户外活动', '经验分享'].includes(tagName) && '相关文章和经验分享'}
          </p>
          <div className="mt-6">
